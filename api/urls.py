...
from api.views import CountryInformation, CountryAuthorities, CountryContractors, CPVInformation, CPVCategories, \
...
urlpatterns = [
    ...
    path('country/<str:country_code>/cpv-info/', CPVInformation.as_view(), name='country_cpv_information'),
